            ...
            <div>
                <form method="get" action="{{ route('user.items.index')}}">
                    <div class="md:flex">
                        ...
                        <div class="mr-4">
                            <span class="text-sm text-white">開催日</span><br>c
                        ...
                        <div class="flex space-x-2 items-center" style="margin-top: 20px;">
                            ...
                            <div><button class="mt-2 ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">検索する</button></div>
                        </div>
