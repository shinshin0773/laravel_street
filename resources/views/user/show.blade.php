                        ...
                        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                          ...
                          <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                            ...
                            <div>
                              ...
                              <a href="https://twitter.com/share?url=https://street-sing.com/show/{{$post->id}}/{{$post->artist_profile_id}}&text=開催情報をシェアしましょう！&related={{ $post->artistprofile->sns_account }}&hashtags=Street,路上ライブ"  class="block twitter-share-button" data-lang="ja" data-count="vertical" data-dnt="true" target="_blank">
